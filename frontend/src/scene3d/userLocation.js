...
export function createUserLocationMarker(scene) {
  ...
  discMat.diffuseColor = new BABYLON.Color3(0.118, 0.251, 0.686);  // #1E40AF 迪士尼主蓝色
  discMat.emissiveColor = new BABYLON.Color3(0.118, 0.251, 0.686); // #1E40AF 自发光
  ...
  ringMat.diffuseColor = new BABYLON.Color3(0.118, 0.251, 0.686);  // #1E40AF 迪士尼主蓝色
  ringMat.emissiveColor = new BABYLON.Color3(0.118, 0.251, 0.686); // #1E40AF
